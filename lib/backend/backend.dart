...
import 'schema/volcanoes_record.dart';
...
export 'schema/volcanoes_record.dart';
...
/// Functions to query VolcanoesRecords (as a Stream and as a Future).
Future<int> queryVolcanoesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VolcanoesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VolcanoesRecord>> queryVolcanoesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VolcanoesRecord.collection,
      VolcanoesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VolcanoesRecord>> queryVolcanoesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
