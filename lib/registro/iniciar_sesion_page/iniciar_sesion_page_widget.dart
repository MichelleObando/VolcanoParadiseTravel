...
class IniciarSesionPageWidget extends StatefulWidget {
  const IniciarSesionPageWidget({super.key});

  static String routeName = 'IniciarSesionPage';
  static String routePath = '/iniciarSesionPage';

  @override
  State<IniciarSesionPageWidget> createState() =>
      _IniciarSesionPageWidgetState();
}

class _IniciarSesionPageWidgetState extends State<IniciarSesionPageWidget> {
  late IniciarSesionPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IniciarSesionPageModel());
